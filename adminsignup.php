...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = "INSERT INTO users (fname, lname, email, password, phone, type) VALUES('$fname', '$lname', '$email','$pass','$phone','admin');";
...
<html lang="en">
  ...
  <label for="exampleInputEmail1" class="form-label"><h1>Add Admins</h1></label>
  <?php
      if(isset($error)){
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit" name="submit">Add an admin</button>
  </div>
</form>
</div>   
