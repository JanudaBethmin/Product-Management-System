...
if(isset($_POST['submit'])){
    ...
    $select = "UPDATE products SET price='$price', description='$description', image='$image'  WHERE name = '$name' ;";
...
<html lang="en">
  ...
  <label for="exampleInputEmail1" class="form-label"><h1>Update Products</h1></label>
  <?php
      if(isset($error)){
